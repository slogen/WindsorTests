    ...
    public class HandlerByCommandTagTests : AbstractWindsorContainerPerTest
    {
        ...
        public class Installer : IWindsorInstaller
        {
            ...
            public class ReleaseHandlerImmediatelyAfterExecuteInterceptor : IInterceptor
            {
                    ...
                    if (typeof(Task).IsAssignableFrom(invocation.Method.ReturnType))
                    {
                        try
                        {
                            ...
                            invocation.ReturnValue =
                                returnValue.ContinueWith(t => { _kernel.ReleaseComponent(invocation.Proxy); });
                        }
                        catch
                        {
                ...
                private static MethodInfo GetInterfaceMethod(Type implementingClass, Type implementedInterface,
